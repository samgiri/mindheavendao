...
- Read-only BSC Testnet health integration with server-side RPC validation, live block reporting, and an empty validated contract-address registry. No transaction or contract-write capability is enabled.
...
- Open decisions, assumptions, risk register, and decision log.
- Mermaid protocol and accounting-flow diagrams.
- Protocol documentation contribution guidance.
...
- Approved MindHeavenDAO Homepage V3 application and visual assets.
